...
import { createMonthlyActivity } from "@/lib/analytics/monthlyActivity";
...
export default function ConversationAnalyzerProgress() {
  ...
  function showLoadedResult(loadedResult: ParsedExport) {
